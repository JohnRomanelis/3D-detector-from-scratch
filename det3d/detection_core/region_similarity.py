...
class RegionSimilarityCalculator(object):
    ...
    def compute(self, boxes1, boxes2):
        """
            Compute matrix of pairwise similarity between BoxLists.

        This op computes a measure of pairwise similarity between
...
class NearestIouSimilarity(RegionSimilarityCalculator):
    """ Class to compare similarity based on the squared distance metric.

    This class computes pairwise similarity between two BoxLists based on 
    the negative square distance metric.
