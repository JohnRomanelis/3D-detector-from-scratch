    ...
    if return_metrics:
        ...
        for j, curcls in enumerate(current_classes):
            for i in range(min_overlaps.shape[0]):
                ...
                # mAPbbox
                easy, moderate, hard = mAPbbox
                ret[key]['mAPbbox']['easy'] = easy 
                ret[key]['mAPbbox']['moderate'] = moderate 
                ret[key]['mAPbbox']['hard'] = hard
                
                # mAPbev
                easy, moderate, hard = mAPbev
                ret[key]['mAPbev']['easy'] = easy 
                ret[key]['mAPbev']['moderate'] = moderate 
                ret[key]['mAPbev']['hard'] = hard 

                # mAP3d
                easy, moderate, hard = mAP3d
                ret[key]['mAP3d']['easy'] = easy 
                ret[key]['mAP3d']['moderate'] = moderate 
                ret[key]['mAP3d']['hard'] = hard 
